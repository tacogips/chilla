// Frozen pre-optimization tokenizer, used only for benchmarks and semantic regression tests.
import { commentStartForSyntax } from "./prDiffSyntaxLanguages";
import { keywordSetForSyntax } from "./prDiffSyntaxKeywordsReference.fixture";
